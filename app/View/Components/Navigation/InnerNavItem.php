...
final class InnerNavItem extends BladeComponent
{
    ...
    public function linkClass(): string
    {
        return collect([
            ...
            $this->active ? 'text-primary-500 bg-blue-gray-200' : 'text-cool-gray-600 hover:text-cool-gray-600 hover:bg-blue-gray-200 focus:text-cool-gray-600 focus:bg-blue-gray-200',
        ])
        ->filter()
        ->implode(' ');
    }
    ...
    public function iconClass(): string
    {
        return collect([
            ...
            $this->active ? 'text-primary-500' : 'text-cool-gray-400 group-hover:text-cool-gray-500 group-focus:text-cool-gray-500',
        ])
        ->filter()
        ->implode(' ');
    }
