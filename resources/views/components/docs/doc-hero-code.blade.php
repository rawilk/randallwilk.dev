@if ($hasHeroCode())
    ...
    <div class="relative rounded-2xl bg-[#0A101F]/80 ring-1 ring-white/10 backdrop-blur">
        <div class="absolute -top-px left-20 right-11 h-px bg-linear-to-r from-sky-300/0 via-sky-300/70 to-sky-300/0"></div>

        <div class="absolute -bottom-px left-11 right-20 h-px bg-linear-to-r from-blue-400/0 via-blue-400 to-blue-400/0"></div>
            ...
            <div class="mt-4 flex space-x-2 text-xs">
                @foreach ($tabs() as $tab)
                    <div @class([
                        ...
                        'bg-linear-to-r from-sky-400/30 via-sky-400 to-sky-400/30 p-px font-medium text-sky-300' => $loop->first,
