...
>
    ...
    {{-- "closed" icon --}}
    <x-heroicon-m-bars-3 id="secondary-menu-closed" class="h-6 w-6" x-bind:class="{ 'hidden': open, 'block': ! open }" />

    {{-- "open" icon --}}
    <x-heroicon-m-x-mark class="h-6 w-6" x-bind:class="{ 'block': open, 'hidden': ! open }" />
</button>
