        ...
        <div class="mx-auto grid max-w-2xl grid-cols-1 items-center gap-y-16 gap-x-8 px-4 lg:max-w-8xl lg:grid-cols-2 lg:px-8 xl:gap-x-16 xl:px-12">
            <div class="relative z-10 md:text-center lg:text-left">
                ...
                <div class="relative">
                    ...
                    <div class="mt-8 flex gap-4 md:justify-center lg:justify-start">
                        <a href="{{ action([\App\Http\Controllers\Docs\DocsController::class, 'show'], [$repository->slug, $alias->slug, 'installation']) }}"
                        ...
                        >
                            {{ __('front.docs.show.get_started_button') }}
                        </a>

                        <a href="{{ $alias->branchUrl() }}"
                        ...
                        >
                            {{ __('front.docs.show.view_on_github_link') }}
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="relative lg:static xl:pl-10">
                ...
                <div class="relative">
                    ...
                    <x-docs.doc-hero-code repository="{{ $repository->slug }}" version="{{ $alias->slug }}" />
                </div>
            </div>
        </div>
    </div>
