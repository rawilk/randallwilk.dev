...
const clipboardSvg = `
<svg class="shrink-0 in-data-copied:hidden h-5 w-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
...
const copiedSvg = `
<svg class="shrink-0 hidden in-data-copied:block h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
