...
export default {
    ...
    computed: {
        /**
         * Generate the tbody CSS classes.
         *
         * @returns {array}
         */
        bodyClasses () {
        ...
        /**
         * Generate the caption CSS classes.
         *
         * @returns {object}
         */
        captionStyles () {
        ...
        /**
         * Generate the items in the table.
         *
         * @returns {array}
         */
        computedItems () {
        ...
        /**
         * Generate the tfoot CSS classes.
         *
         * @returns {array}
         */
        footClasses () {
        ...
        /**
         * Determine if an external provider is present for the table's items.
         *
         * @returns {boolean}
         */
        hasProvider () {
        ...
        /**
         * Generate the thead CSS classes.
         *
         * @returns {array}
         */
        headClasses () {
        ...
        /**
         * Determine if table is responsive.
         *
         * @returns {boolean}
         */
        isResponsive () {
        ...
        /**
         * Determine if local filtering should be used.
         *
         * @returns {boolean}
         */
        localFiltering () {
        ...
        /**
         * Determine if local paging should be used.
         *
         * @returns {boolean}
         */
        localPaging () {
        ...
        /**
         * Determine if local sorting should be used.
         *
         * @returns {boolean}
         */
        localSorting () {
        ...
        /**
         * Generate the responsive CSS classes.
         *
         * @returns {string}
         */
        responsiveClass () {
        ...
        /**
         * Generate the table CSS classes.
         *
         * @returns {array}
         */
        tableClasses () {
            ...
            rows.push(
                h(
                    'tr',
                    {
                        ...
                        on: {
                            click: event => {
                                this.rowClicked(event, item, rowIndex);
                            },
                            dblclick: event => {
                                this.rowDblClicked(event, item, rowIndex);
                            },
                            mouseenter: event => {
                                this.rowHovered(event, item, rowIndex);
                            }
                        }
                    },
                    tds
    ...
    mounted () {
        ...
        this.listenOnRoot('lara::refresh::table', id => {
    ...
    methods: {
        ...
        /***
         * Determine classes for the given field.
         *
         * @param {object} field
         * @returns {array}
         */
        ...
        /**
         * Get a formatted value for the given field.
         *
         * @param {object} item
         * @param {object} field
         * @returns {*}
        ...
        /**
         * Handle a heading being clicked.
         *
         * @param {MouseEvent} event
         * @param {object} field
         */
        headClicked (event, field) {
            if (this.stopIfBusy(event)) {
            ...
            this.$emit('head-clicked', field.key, field, event);
        ...
        /**
         * Refresh an external data provider.
         */
        refresh () {
        ...
        /**
         * Generate CSS classes for the given row.
         *
         * @param {object} item
         * @returns {array}
         */
        ...
        /**
         * Handle a row double click event.
         *
         * @param {MouseEvent} event
         * @param {object} item
         * @param {number} index
         */
        rowDblClicked (event, item, index) {
            if (this.stopIfBusy(event)) {
                // If table is busy (via provider) then don't propagate
                return;
            }

            this.$emit('row-dblclicked', item, index, event);
        },

        /**
         * Handle a row hovered event.
         *
         * @param {Event} event
         * @param {object} item
         * @param {number} index
         */
        rowHovered (event, item, index) {
            if (this.stopIfBusy(event)) {
                // If table is busy (via provider) then don't propagate
                return;
            }

            this.$emit('row-hovered', item, index, event);
        },

        /**
         * Stop the given event if table is busy.
         *
         * @param {Event} event
         * @returns {boolean}
         */
        ...
        /**
         * Generate td attributes for the given cell.
         *
         * @param {object} field
         * @param {object} item
         * @param colIndex
        ...
        /**
         * Generate td classes for the given cell.
         *
         * @param {object} field
         * @param {object} item
         * @returns {object}
        ...
        _providerSetLocal (items) {
            ...
            // New root emit
            if (this.id) {
                this.emitOnRoot('lara::table::refreshed', this.id);
            }
        },

        /**
         * Request new items from external provider.
         *
         * @private
         */
        _providerUpdate () {
