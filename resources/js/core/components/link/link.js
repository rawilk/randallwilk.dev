...
export const computed = {
    /**
     * Generate the properties of the link.
     *
     * @returns {object}
     */
    linkProps () {
...
/**
 * Determine if `router-link` or `a` should be used as the tag.
 *
 * @param {object} props
 * @param {object} parent
 * @returns {string}
...
/**
 * Determine the href property of the link.
 *
